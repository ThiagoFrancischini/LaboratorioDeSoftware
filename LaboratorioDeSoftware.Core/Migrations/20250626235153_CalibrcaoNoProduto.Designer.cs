...
namespace LaboratorioDeSoftware.Core.Migrations
{
    ...
    [Migration("20250626235153_CalibrcaoNoProduto")]
    partial class CalibrcaoNoProduto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaboratorioDeSoftware.Core.Entities.Calibracao", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("Erro")
                        .HasColumnType("double precision");

                    b.Property<string>("GrandezaParametro")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<double>("Incerteza")
                        .HasColumnType("double precision");

                    b.Property<long>("NumeroSolicitacao")
            ...
            modelBuilder.Entity("LaboratorioDeSoftware.Core.Entities.ConfiguracaoSistema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("DiasDeAntecedenciaAvisos")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LaboratorioDeSoftware.Core.Entities.ManutencaoCorretiva", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<DateTime>("DataProblemaApresentado")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("ManutencoesCorretivas");
                });
            ...
            modelBuilder.Entity("LaboratorioDeSoftware.Core.Entities.Produto", b =>
                {
                    b.HasOne("LaboratorioDeSoftware.Core.Entities.CategoriaItem", "Categoria")
                        .WithMany()
